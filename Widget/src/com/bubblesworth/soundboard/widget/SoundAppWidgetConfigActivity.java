...
public class SoundAppWidgetConfigActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// wait for the result.
		if (savedInstanceState == null || !savedInstanceState.getBoolean(STATEKEY_WASRUNNING))
		{
			// Take advantage of the Android activity selection code,
			// any compatible soundboard should respond to this action with a
			// ContentProvider URL.
			// I wonder if or how I can export this...? I guess you just document
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		SoundAppWidgetProvider.updateAppWidget(this, appWidgetManager, widgetId, asset);
	...
	// This is actually called from SoundAppWidgetProvider, but it's here because
	...
	static Uri retreiveContentURIForWidget(Context context, int appWidgetId) {
		...
		String asset = prefs.getString(PREF_WIDGET_ASSET_KEY + appWidgetId, null);
		if (asset == null)
			return null;
		return Uri.parse(asset);
	}

	static void storeContentURIForWidget(Context context, int appWidgetId, Uri asset) {
